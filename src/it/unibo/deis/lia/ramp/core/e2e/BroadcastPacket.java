...
public class BroadcastPacket extends GenericPacket {
    ...
    public BroadcastPacket(
        ...
        this.id = ((RampUtilsInterface) ComponentLocator.getComponent(ComponentType.RAMP_UTILS)).nextRandomInt(); //Stefano Lanzone
        this.ttl = ttl;
	...
	*/
    ...
    public void writeToProtos(java.io.OutputStream os) throws IOException {
